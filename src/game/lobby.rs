...
mod tests {
    use super::{
        ...
        new_human_lobby_player, ready_connected_participants, remove_lobby_player,
        rename_lobby_player, set_lobby_ai_difficulty, set_lobby_ready, unique_lobby_name,
    };
    ...
    fn rename_lobby_player_dedupes_and_rejects_racing_phase() {
        ...
        let outcome =
            rename_lobby_player(&mut players, NetworkRacePhase::Lobby, PlayerId(2), "host")
                .unwrap();
